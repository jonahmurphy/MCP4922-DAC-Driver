...
Although if using a compiler other the C51 Keil compiler the following C51 specific elements will need to changed.

**1)**
The chip select pin is defined using the non-portable sbit type.
`````````````````
